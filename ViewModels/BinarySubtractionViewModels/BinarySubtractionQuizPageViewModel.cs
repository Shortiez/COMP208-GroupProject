...
public partial class BinarySubtractionQuizPageViewModel : ViewModelBase
{

    [ObservableProperty]
    private TopicContentModel topicContentModel;
    
    private UserStatisticData _userStatistics = new UserStatisticData(App.MainWindowViewModel.User.Username, "Binary Arithmetic", "Binary Subtraction");
    ...
    public BinarySubtractionQuizPageViewModel()
    {
        GenerateNewQuestion();
    }
    ...
    private void OnClickToLearn()
    {
        ...
        // App.MainWindowViewModel.CurrentContent = new BinarySubtractionLearnPageViewModel(_currentQuestion);
    }
}